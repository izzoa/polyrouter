...
ALTER TABLE "request_log" ADD CONSTRAINT "request_log_structural_scope_valid" CHECK ("request_log"."structural_scope" IS NULL OR "request_log"."structural_scope" IN ('tenant', 'agent'));